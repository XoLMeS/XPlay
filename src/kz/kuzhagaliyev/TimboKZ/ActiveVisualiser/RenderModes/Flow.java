...
public class Flow extends RenderMode {
    ...
    public void render(float delta) {
        ...
        while(flowParticles.size() < 400) {
            ...
            flowParticles.add(new FlowParticle(-20.0f * (1 - multiplier) * 2, Display.getHeight() * randomiser, 20.0f * (1 - multiplier), 20.0f * multiplier, 50.0f * multiplier, 2 * (float) Math.PI * randomiser2));
        }
